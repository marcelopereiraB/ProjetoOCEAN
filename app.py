...
class User(UserMixin, db.Model):
        ...
        def creck_password(self, password):
                return creck_password_hash(self.password_hash, password)
...
def login():
        ...
        if request.method == "POST":
                ...
                if user is None or not user.creck_password(password):
